...
# Constants
CHROMA_PATH = os.getenv("TRUEFALSE_DATA_PATH")
DATA_PATH = os.getenv("TRUEFALSE_CHROMA_DATABASE_PATH")
SUPABASE_URL = os.getenv("SUPABASE_URL")
SUPABASE_KEY = os.getenv("SUPABASE_KEY")

class TrueFalseExercise(BaseTool):
    name: str = "true_false_exercise"
    description: str = "A tool to retrieve true/false exercises from a database."
