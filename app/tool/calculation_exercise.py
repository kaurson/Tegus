...
# Constants
CHROMA_PATH = os.getenv("CALCULATION_EXERCISE_DATA_PATH")
DATA_PATH = os.getenv("CALCULATION_EXERCISE_CHROMA_DATABASE_PATH")
SUPABASE_URL = os.getenv("SUPABASE_URL")
SUPABASE_KEY = os.getenv("SUPABASE_KEY")

class CalculationExercise(BaseTool):
    name: str = "calculation_exercise"
    description: str = "A tool to retrieve calculation exercises from a database."
